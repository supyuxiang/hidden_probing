...
CUDA_VISIBLE_DEVICES=0 python /root/hidden_prob/exp1_math/judge.py \
    ...
    --save_path /root/autodl-tmp/exp1_math/judge/reward_math_test_zh_n8_t1.5_tokens1024.pt
...
CUDA_VISIBLE_DEVICES=0 python /root/hidden_prob/exp1_math/judge.py \
    ...
    --save_path /root/autodl-tmp/exp1_math/judge/reward_math_test_es_n8_t1.5_tokens1024.pt
...
CUDA_VISIBLE_DEVICES=0 python /root/hidden_prob/exp1_math/judge.py \
    ...
    --save_path /root/autodl-tmp/exp1_math/judge/reward_math_test_vi_n8_t1.5_tokens1024.pt
...
CUDA_VISIBLE_DEVICES=0 python /root/hidden_prob/exp1_math/judge.py \
    ...
    --save_path /root/autodl-tmp/exp1_math/judge/reward_math_test_tr_n8_t1.5_tokens1024.pt
