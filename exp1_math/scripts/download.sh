...
mkdir -p /root/autodl-tmp/bert-base-multilingual-cased/
HF_ENDPOINT=https://hf-mirror.com hf download google-bert/bert-base-multilingual-cased --local-dir /root/autodl-tmp/bert-base-multilingual-cased/ 
